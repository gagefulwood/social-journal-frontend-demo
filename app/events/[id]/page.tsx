          ...
          <Button asChild variant="outline">
            ...
            <section className="rounded-2xl border border-border bg-card p-8 shadow-sm">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-[1.5fr_1fr] gap-16 items-start">
                ...
                <div className="w-full xl:w-[420px] rounded-2xl bg-slate-600 p-8 text-white">
                ...
                <div className="mt-6 flex flex-wrap gap-5">
                    ...
                    event.participants.map((participant) => (
                        ...
                        className="flex h-24 w-24 flex-col items-center justify-center rounded-full border border-white/20 bg-white p-3 text-center text-xs shadow-sm"
                        >
